...
export type StoryDiagnostics = {
  ...
  latestGenerationAttemptId?: string;
  storyGenerationFailureStage?: string;
  storyGenerationFailureReason?: string | null;
  storyGenerationFailureSource?: string;
  storyGenerationRetryAttempted?: boolean;
  storyGenerationRetrySucceeded?: boolean;
  storyMetadataLeakScanTarget?: string;
  storyMetadataLeakDetected?: boolean;
  storyMetadataLeakSanitized?: boolean;
  storyMetadataLeakFinalClean?: boolean;
  storyMetadataLeakRemovedPatterns?: string[];
  storyRawCandidateLength?: number;
  storySanitizedCandidateLength?: number;
  storyRepairAttempted?: boolean;
  fallbackDisplayBlocked?: boolean;
  ...
  metadataLeakGuardTriggered?: boolean;
